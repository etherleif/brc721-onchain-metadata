...
export const rejectFakeProof = (index: number) => {
  console.log(`Rejecting fake proof for index ${index}...`);
  ...
  if (isValid) {
    console.error("The fake Proof is valid ❌");
  } else {
    console.log("The fake Proof is invalid ✅");
  }
};
